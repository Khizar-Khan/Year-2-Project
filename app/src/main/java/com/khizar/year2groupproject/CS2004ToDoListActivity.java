...
public class CS2004ToDoListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toDoList = FileHelper3.readData(this);
    ...
    public void addItemBTN(View view)
    {
        ...
        {
            Toast.makeText(CS2004ToDoListActivity.this, "Please enter a task", Toast.LENGTH_SHORT).show();
        }
        else
        {
            arrayAdapter.add(taskEntered);
            editText.setText("");
            FileHelper3.writeData(toDoList, this);
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
    {
        ...
        aBuilder.setMessage("Are you sure?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialogInterface, int i)
            {
                ...
                FileHelper3.writeData(toDoList, CS2004ToDoListActivity.this);
            }
