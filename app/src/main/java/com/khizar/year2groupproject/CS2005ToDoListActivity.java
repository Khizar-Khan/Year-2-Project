...
public class CS2005ToDoListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toDoList = FileHelper4.readData(this);
    ...
    public void addItemBTN(View view)
    {
        ...
        {
            Toast.makeText(CS2005ToDoListActivity.this, "Please enter a task", Toast.LENGTH_SHORT).show();
        }
        else
        {
            arrayAdapter.add(taskEntered);
            editText.setText("");
            FileHelper4.writeData(toDoList, this);
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
    {
        ...
        aBuilder.setMessage("Are you sure?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialogInterface, int i)
            {
                ...
                FileHelper4.writeData(toDoList, CS2005ToDoListActivity.this);
            }
