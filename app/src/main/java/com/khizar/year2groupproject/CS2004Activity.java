...
public class CS2004Activity extends AppCompatActivity {
    ...
    public int currentCount = Integer.valueOf(readHours.get(4));
    public int currentCount2 = Integer.valueOf(readHours.get(5));
    public int sghours = Integer.valueOf(assignmentHours.get(4));
    public int sghours2 = Integer.valueOf(assignmentHours.get(5));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> userGrade = sqlConnector.readUserGrade("CS2004");
        ...
        double weightOne = Integer.valueOf(assessmentInformation.get(14));
        double gradeTwo = Integer.valueOf(userGrade.get(1));
        double weightTwo = Integer.valueOf(assessmentInformation.get(17));
        ...
        assessment.setText(assessmentInformation.get(12));
    ...
    {
        Intent intent = new Intent(getApplicationContext(), CS2004GradesActivity.class);
        startActivity(intent);
    }
    public void PlusCounter(View view)
    {
        ...
        sqlConnector2.UpdateHours(5, currentCount);
    ...
    public void PlusCounter2(View view)
    {
        ...
        sqlConnector2.UpdateHours(6, currentCount2);
    ...
    public void countDownStart() {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                String date = assessmentInformation.get(13);
                String date2 = assessmentInformation.get(16);
